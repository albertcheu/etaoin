...
if __name__ == "__main__":
    ...
    print 'How many are shared among the six images?'
    ...
    for line in lines:
        ...
        shared = True
        for i in range(6):
            bgc, shapeDescList = metaList[i]
            ans, assertion = processWords(words, bgc, shapeDescList)
            if ans != YES:
                shared = False
                break
            pass
        if shared: sharedTruths.append(line)
        pass
